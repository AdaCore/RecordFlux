...
def test_message_duplicate_link() -> None:
    ...
    structure = [
        Link(INITIAL, x),
        Link(x, Field("Final"), location=Location((4, 42))),
        Link(x, Field("Final"), location=Location((5, 42))),
    ]
...
def test_message_multiple_duplicate_links() -> None:
    ...
    structure = [
        Link(INITIAL, x),
        Link(x, y),
        Link(x, Field("Final"), location=Location((3, 16))),
        Link(x, Field("Final"), location=Location((4, 18))),
        Link(y, Field("Final"), location=Location((5, 20))),
        Link(y, Field("Final"), location=Location((6, 22))),
    ]
