    ...
    def test_prefixed_message(self) -> None:
        self.assertEqual(
            ...
            UnprovenMessage(
                ...
                {
                    Field("X_F1"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("X_F2"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("X_F3"): deepcopy(RANGE_INTEGER).embedded,
                    Field("X_F4"): Opaque().embedded,
                },
            ),
        )
    ...
    def test_merge_message_simple(self) -> None:
        ...
        self.assertEqual(
            ...
            UnprovenMessage(
                ...
                {
                    Field("NR_F1"): Opaque().embedded,
                    Field("NR_F2"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("NR_F3"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("NR_F4"): deepcopy(RANGE_INTEGER).embedded,
                },
            ),
        )
    ...
    def test_merge_message_recursive(self) -> None:
        ...
        self.assertEqual(
            ...
            UnprovenMessage(
                ...
                {
                    Field("SR_NR_F1"): Opaque().embedded,
                    Field("SR_NR_F2"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("SR_NR_F3"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("SR_NR_F4"): deepcopy(RANGE_INTEGER).embedded,
                    Field("NR_F1"): Opaque().embedded,
                    Field("NR_F2"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("NR_F3"): deepcopy(MODULAR_INTEGER).embedded,
                    Field("NR_F4"): deepcopy(RANGE_INTEGER).embedded,
