...
is
   ...
   type State is (S_Start, S_Reply_1, S_Reply_2, S_Terminated);
...
private
   ...
   function Uninitialized (Ctx : Context'Class) return Boolean is
     (not Universal.Message.Has_Buffer (Ctx.P.Message_1_Ctx)
   ...
   function Global_Initialized (Ctx : Context'Class) return Boolean is
     (Universal.Message.Has_Buffer (Ctx.P.Message_1_Ctx)
