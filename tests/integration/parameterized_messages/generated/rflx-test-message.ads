...
is
   ...
   procedure Copy (Ctx : Context; Buffer : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.Test.Message.Has_Buffer (Ctx)
       and then RFLX.Test.Message.Structural_Valid_Message (Ctx)
   ...
   function Get_Data (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.Test.Message.Has_Buffer (Ctx)
       and then RFLX.Test.Message.Structural_Valid (Ctx, RFLX.Test.Message.F_Data)
   ...
   function Get_Extension (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.Test.Message.Has_Buffer (Ctx)
       and then RFLX.Test.Message.Structural_Valid (Ctx, RFLX.Test.Message.F_Extension)
