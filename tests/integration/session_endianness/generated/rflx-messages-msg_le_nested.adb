...
is
   ...
   begin
      ...
      First := Field_First (Ctx, F_X_A);
      Last := Field_Last (Ctx, F_X_A);
   ...
   begin
      ...
      First := Field_First (Ctx, F_X_B);
      Last := Field_Last (Ctx, F_X_B);
   ...
   begin
      ...
      First := Field_First (Ctx, F_Y);
      Last := Field_Last (Ctx, F_Y);
