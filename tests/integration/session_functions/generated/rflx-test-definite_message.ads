...
package RFLX.Test.Definite_Message with
  SPARK_Mode,
  Annotate =>
...
is
   ...
   type Virtual_Field is (F_Initial, F_Message_Type, F_Length, F_Data, F_Final);
   ...
   procedure Reset (Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and RFLX.Test.Definite_Message.Has_Buffer (Ctx),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Copy (Ctx : Context; Buffer : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Structural_Valid_Message (Ctx)
       and then RFLX.Test.Definite_Message.Byte_Size (Ctx) = Buffer'Length;
   ...
   procedure Generic_Write (Ctx : in out Context; Offset : RFLX_Types.Length := 0) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then Offset < RFLX.Test.Definite_Message.Buffer_Length (Ctx)
       and then Pre (RFLX.Test.Definite_Message.Buffer_Length (Ctx), Offset),
     Post =>
       Has_Buffer (Ctx)
       and Ctx.Buffer_First = Ctx.Buffer_First'Old
       and Ctx.Buffer_Last = Ctx.Buffer_Last'Old
   ...
   procedure Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Structural_Valid_Message (Ctx)
       and then Data'Length = RFLX.Test.Definite_Message.Byte_Size (Ctx);
   ...
   function Field_Condition (Ctx : Context; Fld : Field) return Boolean with
     Pre =>
       RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Valid_Predecessor (Ctx, Fld)
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, Fld)
       and then RFLX.Test.Definite_Message.Available_Space (Ctx, Fld) >= RFLX.Test.Definite_Message.Field_Size (Ctx, Fld),
     Post =>
       True;
   ...
   function Field_Size (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length with
     Pre =>
       RFLX.Test.Definite_Message.Valid_Next (Ctx, Fld),
     Post =>
       (case Fld is
           when F_Data =>
   ...
   function Get_Message_Type (Ctx : Context) return RFLX.Universal.Option_Type with
     Pre =>
       RFLX.Test.Definite_Message.Valid (Ctx, RFLX.Test.Definite_Message.F_Message_Type);

   function Get_Length (Ctx : Context) return RFLX.Test.Length with
     Pre =>
       RFLX.Test.Definite_Message.Valid (Ctx, RFLX.Test.Definite_Message.F_Length);
   ...
   function Get_Data (Ctx : Context) return RFLX_Types.Bytes with
     ...
     Pre =>
       RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Structural_Valid (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, RFLX.Test.Definite_Message.F_Data),
     Post =>
   ...
   procedure Get_Data (Ctx : Context; Data : out RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.Test.Definite_Message.Structural_Valid (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then Data'Length = RFLX_Types.To_Length (RFLX.Test.Definite_Message.Field_Size (Ctx, RFLX.Test.Definite_Message.F_Data)),
     Post =>
   ...
   procedure Generic_Get_Data (Ctx : Context) with
     Pre =>
       RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and RFLX.Test.Definite_Message.Present (Ctx, RFLX.Test.Definite_Message.F_Data);
   ...
   procedure Set_Message_Type (Ctx : in out Context; Val : RFLX.Universal.Option_Type_Enum) with
     ...
     Pre =>
       not Ctx'Constrained
       and then RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, RFLX.Test.Definite_Message.F_Message_Type)
       and then RFLX.Universal.Valid_Option_Type (RFLX.Universal.To_Base_Integer (Val))
       and then RFLX.Test.Definite_Message.Available_Space (Ctx, RFLX.Test.Definite_Message.F_Message_Type) >= RFLX.Test.Definite_Message.Field_Size (Ctx, RFLX.Test.Definite_Message.F_Message_Type)
       and then RFLX.Test.Definite_Message.Field_Condition (Ctx, RFLX.Test.Definite_Message.F_Message_Type),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.Test.Length) with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
       and then RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, RFLX.Test.Definite_Message.F_Length)
       and then RFLX.Test.Valid_Length (RFLX.Test.To_Base_Integer (Val))
       and then RFLX.Test.Definite_Message.Available_Space (Ctx, RFLX.Test.Definite_Message.F_Length) >= RFLX.Test.Definite_Message.Field_Size (Ctx, RFLX.Test.Definite_Message.F_Length)
       and then RFLX.Test.Definite_Message.Field_Condition (Ctx, RFLX.Test.Definite_Message.F_Length),
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Data_Empty (Ctx : in out Context) with
     Pre =>
       ...
       and then RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Available_Space (Ctx, RFLX.Test.Definite_Message.F_Data) >= RFLX.Test.Definite_Message.Field_Size (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Field_Condition (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Field_Size (Ctx, RFLX.Test.Definite_Message.F_Data) = 0,
     Post =>
       Has_Buffer (Ctx)
   ...
   procedure Set_Data (Ctx : in out Context; Data : RFLX_Types.Bytes) with
     Pre =>
       ...
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Available_Space (Ctx, RFLX.Test.Definite_Message.F_Data) >= RFLX.Test.Definite_Message.Field_Size (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Valid_Length (Ctx, RFLX.Test.Definite_Message.F_Data, Data'Length)
       and then RFLX.Test.Definite_Message.Available_Space (Ctx, RFLX.Test.Definite_Message.F_Data) >= Data'Length * RFLX_Types.Byte'Size
       and then RFLX.Test.Definite_Message.Field_Condition (Ctx, RFLX.Test.Definite_Message.F_Data),
     Post =>
       Has_Buffer (Ctx)
       and Structural_Valid (Ctx, F_Data)
   ...
   procedure Generic_Set_Data (Ctx : in out Context; Length : RFLX_Types.Length) with
     Pre =>
       ...
       and then RFLX.Test.Definite_Message.Valid_Next (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Available_Space (Ctx, RFLX.Test.Definite_Message.F_Data) >= RFLX.Test.Definite_Message.Field_Size (Ctx, RFLX.Test.Definite_Message.F_Data)
       and then RFLX.Test.Definite_Message.Valid_Length (Ctx, RFLX.Test.Definite_Message.F_Data, Length)
       and then RFLX_Types.To_Length (RFLX.Test.Definite_Message.Available_Space (Ctx, RFLX.Test.Definite_Message.F_Data)) >= Length
   ...
   type Structure is
      record
         ...
         Data : RFLX_Types.Bytes (RFLX_Types.Index'First .. RFLX_Types.Index'First + 254);
      end record;
   ...
   procedure To_Context (Struct : Structure; Ctx : in out Context) with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Test.Definite_Message.Has_Buffer (Ctx)
       and then RFLX.Test.Definite_Message.Valid_Structure (Struct)
       and then RFLX.Test.Definite_Message.Sufficient_Buffer_Length (Ctx, Struct),
     Post =>
       Has_Buffer (Ctx)
...
private
   ...
   function Initialized (Ctx : Context) return Boolean is
     (Ctx.Verified_Last = Ctx.First - 1
      ...
      and then RFLX.Test.Definite_Message.Field_First (Ctx, RFLX.Test.Definite_Message.F_Message_Type) rem RFLX_Types.Byte'Size = 1
   ...
   function Field_Condition (Ctx : Context; Fld : Field) return Boolean is
     ((case Fld is
          when F_Message_Type | F_Length | F_Data =>
             True));
   ...
   function Get_Length (Ctx : Context) return RFLX.Test.Length is
