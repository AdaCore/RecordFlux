...
is
   ...
   function Successor (Ctx : Context; Fld : Field) return Virtual_Field is
     ((case Fld is
          when F_Option_Type =>
             (if
                 RFLX_Types.U64 (Ctx.Cursors (F_Option_Type).Value) = RFLX_Types.U64 (To_U64 (RFLX.Universal.OT_Null))
              then
                 F_Final
              elsif
   ...
   begin
      Set (Ctx, F_Option_Type, Value, 8, True, Buffer_First, Buffer_Last, Offset);
