...
is
          ...
          when F_Message_Type =>
             (if
              ...
              then
                 ...
                 RFLX_Types.Base_Integer (Ctx.Cursors (F_Message_Type).Value) = RFLX_Types.Base_Integer (To_Base_Int (RFLX.Universal.MT_Null))
              then
                 F_Final
              elsif
   ...
   begin
      Set_Scalar (Ctx, F_Value, To_Base_Int (Val));
   end Set_Value;
