package body Ethernet.Version_2 is
   ...
   begin
      return (Buffer'Length >= 14 and then Convert_To_U16 (Buffer (Buffer'First + 12 .. Buffer'First + 13)) >= 1536);
   end Valid_EtherType;
   ...
   begin
      return (Buffer'Length >= 14 and then ((Buffer'Length >= 60 and then Buffer'Length <= 1514) and then EtherType (Buffer) >= 1536));
   end Valid_Payload;
