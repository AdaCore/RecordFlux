...
is
   ...
   function Get_Copied_0 (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Copied (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Option_Class_00 (Buffer : Bytes) return Option_Class_Type is
   ...
   function Get_Option_Class (Buffer : Bytes) return Option_Class_Type is
   ...
   function Get_Option_Number_000 (Buffer : Bytes) return Option_Number_Type is
   ...
   function Get_Option_Number (Buffer : Bytes) return Option_Number_Type is
   ...
   function Get_Option_Length_0001 (Buffer : Bytes) return Option_Length_Type is
   ...
   function Get_Option_Length (Buffer : Bytes) return Option_Length_Type is
   ...
   function Get_Option_Data_00010_First (Buffer : Bytes) return Natural is
      ((Buffer'First + 2))
     with
       Pre => (Is_Contained (Buffer) and then Valid_Option_Data_00010 (Buffer));

   function Get_Option_Data_00010_Last (Buffer : Bytes) return Natural is
   ...
   function Get_Option_Data_First (Buffer : Bytes) return Natural is
   ...
   function Get_Option_Data_Last (Buffer : Bytes) return Natural is
      ((if Valid_Option_Data_00010 (Buffer) then Get_Option_Data_00010_Last (Buffer) else Unreachable_Natural))
     with
       Pre => (Is_Contained (Buffer) and then Valid_Option_Data (Buffer));

   procedure Get_Option_Data (Buffer : Bytes; First : out Natural; Last : out Natural)
     with
       Pre => (Is_Contained (Buffer) and then Valid_Option_Data (Buffer)),
