...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["file1.pyi"], ["file1_test.py"], None),
        (["file1.py", "file1.pyi"], ["file1_test.py"], None),
        (["subdir/file1.py"], ["subdir/file1_test.py"], None),
        (["subdir/file1.pyi"], ["subdir/file1_test.py"], None),
        (["subdir/file1.pyi", "subdir/file1.pyi"], ["subdir/file1_test.py"], None),
