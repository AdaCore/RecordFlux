...
package RFLX.Test.Definite_Message
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   function Get_Message_Type (Ctx : Context) return RFLX.Universal.Option_Type
   with
     Pre =>
   ...
   procedure Set_Message_Type (Ctx : in out Context; Val : RFLX.Universal.Option_Type_Enum)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   function Field_Size_Message_Type (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);
