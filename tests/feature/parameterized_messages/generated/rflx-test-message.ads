...
is
   ...
   type Context (Buffer_First, Buffer_Last : RFLX_Types.Index := RFLX_Types.Index'First; First : RFLX_Types.Bit_Index := RFLX_Types.Bit_Index'First; Last : RFLX_Types.Bit_Length := RFLX_Types.Bit_Length'First; Length : Test.Length := Test.Length'First; Extended : Boolean := Boolean'First) is private
   with
   ...
   procedure Initialize (Ctx : out Context; Buffer : in out RFLX_Types.Bytes_Ptr; Length : Test.Length; Extended : Boolean; Written_Last : RFLX_Types.Bit_Length := 0)
   with
     Pre =>
       not Ctx'Constrained
   ...
   procedure Initialize (Ctx : out Context; Buffer : in out RFLX_Types.Bytes_Ptr; First : RFLX_Types.Bit_Index; Last : RFLX_Types.Bit_Length; Length : Test.Length; Extended : Boolean; Written_Last : RFLX_Types.Bit_Length := 0)
   with
     Pre =>
       not Ctx'Constrained
       and then Buffer /= null
   ...
   procedure Reset (Ctx : in out Context; Length : Test.Length; Extended : Boolean)
   with
     Pre =>
       not Ctx'Constrained
   ...
   procedure Reset (Ctx : in out Context; First : RFLX_Types.Bit_Index; Last : RFLX_Types.Bit_Length; Length : Test.Length; Extended : Boolean)
   with
     Pre =>
       not Ctx'Constrained
       and RFLX.Test.Message.Has_Buffer (Ctx)
   ...
   function Valid_Value (Unused_Fld : Field; Unused_Val : RFLX_Types.Base_Integer) return Boolean
   with
     Post =>
       True;
   ...
   function Get_Extension (Ctx : Context) return RFLX_Types.Bytes
   with
     Ghost,
     Pre =>
       RFLX.Test.Message.Has_Buffer (Ctx)
   ...
   procedure Get_Extension (Ctx : Context; Data : out RFLX_Types.Bytes)
   with
     Pre =>
       RFLX.Test.Message.Has_Buffer (Ctx)
       and then RFLX.Test.Message.Well_Formed (Ctx, RFLX.Test.Message.F_Extension)
   ...
   procedure Generic_Get_Extension (Ctx : Context)
   with
     Pre =>
       RFLX.Test.Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_Extension (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Test.Message.Has_Buffer (Ctx)
   ...
   procedure Set_Extension (Ctx : in out Context; Data : RFLX_Types.Bytes)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Test.Message.Has_Buffer (Ctx)
   ...
   generic
      ...
      with function Process_Data_Pre (Length : RFLX_Types.Length) return Boolean;
   procedure Generic_Set_Extension (Ctx : in out Context; Length : RFLX_Types.Length)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Test.Message.Has_Buffer (Ctx)
...
private
   ...
   function Valid_Predecessors_Invariant (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Length : Test.Length; Extended : Boolean) return Boolean is
   ...
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last, Length, Extended)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, Length, Extended, Fld);
   ...
   function Field_First_Data (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Length : Test.Length; Extended : Boolean) return RFLX_Types.Bit_Index'Base is
     (First)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last, Length, Extended)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, Length, Extended, F_Data);

   function Field_First_Extension (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Length : Test.Length; Extended : Boolean) return RFLX_Types.Bit_Index'Base is
     (Field_First_Data (Cursors, First, Verified_Last, Written_Last, Length, Extended) + Field_Size_Internal (Cursors, First, Verified_Last, Written_Last, Length, Extended, F_Data))
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last, Length, Extended)
   ...
   function Field_First (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Index is
     (Field_First_Internal (Ctx.Cursors, Ctx.First, Ctx.Verified_Last, Ctx.Written_Last, Ctx.Length, Ctx.Extended, Fld));

   function Field_Last (Ctx : Context; Fld : Field) return RFLX_Types.Bit_Length is
     (Field_First (Ctx, Fld) + Field_Size (Ctx, Fld) - 1);

   function Valid_Next (Ctx : Context; Fld : Field) return Boolean is
     (Valid_Next_Internal (Ctx.Cursors, Ctx.First, Ctx.Verified_Last, Ctx.Written_Last, Ctx.Length, Ctx.Extended, Fld));
