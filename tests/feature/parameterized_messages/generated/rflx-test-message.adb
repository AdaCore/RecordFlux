...
is
   ...
   begin
      Ctx := (Buffer_First, Buffer_Last, First, Last, Length, Extended, First - 1, (if Written_Last = 0 then First - 1 else Written_Last), Buffer, (others => <>));
      Buffer := null;
   end Initialize;
   ...
   begin
      Ctx := (Ctx.Buffer_First, Ctx.Buffer_Last, First, Last, Length, Extended, First - 1, First - 1, Ctx.Buffer, (others => <>));
   end Reset;
