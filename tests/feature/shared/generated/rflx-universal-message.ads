...
package RFLX.Universal.Message
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   function Get_Message_Type (Ctx : Context) return RFLX.Universal.Message_Type
   with
     Pre =>
       RFLX.Universal.Message.Valid (Ctx, RFLX.Universal.Message.F_Message_Type);

   function Get_Length (Ctx : Context) return RFLX.Universal.Length
   with
     Pre =>
       RFLX.Universal.Message.Valid (Ctx, RFLX.Universal.Message.F_Length);

   function Get_Value (Ctx : Context) return RFLX.Universal.Value
   with
     Pre =>
   ...
   procedure Set_Message_Type (Ctx : in out Context; Val : RFLX.Universal.Message_Type)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Length (Ctx : in out Context; Val : RFLX.Universal.Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Value (Ctx : in out Context; Val : RFLX.Universal.Value)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Option_Types_Empty (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Set_Values_Empty (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Set_Option_Types (Ctx : in out Context; Seq_Ctx : RFLX.Universal.Option_Types.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Set_Options (Ctx : in out Context; Seq_Ctx : RFLX.Universal.Options.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Set_Values (Ctx : in out Context; Seq_Ctx : RFLX.Universal.Values.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_Option_Types (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_Options (Ctx : in out Context; Length : RFLX_Types.Length)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_Values (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Universal.Message.Has_Buffer (Ctx)
   ...
   procedure Switch_To_Option_Types (Ctx : in out Context; Seq_Ctx : out RFLX.Universal.Option_Types.Context)
   with
     Pre =>
       not Ctx'Constrained
   ...
   procedure Switch_To_Options (Ctx : in out Context; Seq_Ctx : out RFLX.Universal.Options.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then not Seq_Ctx'Constrained
   ...
   procedure Switch_To_Values (Ctx : in out Context; Seq_Ctx : out RFLX.Universal.Values.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then not Seq_Ctx'Constrained
   ...
   function Complete_Option_Types (Ctx : Context; Seq_Ctx : RFLX.Universal.Option_Types.Context) return Boolean
   with
     Pre =>
       RFLX.Universal.Message.Valid_Next (Ctx, RFLX.Universal.Message.F_Option_Types);

   function Complete_Options (Ctx : Context; Seq_Ctx : RFLX.Universal.Options.Context) return Boolean
   with
     Pre =>
       RFLX.Universal.Message.Valid_Next (Ctx, RFLX.Universal.Message.F_Options);

   function Complete_Values (Ctx : Context; Seq_Ctx : RFLX.Universal.Values.Context) return Boolean
   with
     Pre =>
       RFLX.Universal.Message.Valid_Next (Ctx, RFLX.Universal.Message.F_Values);

   procedure Update_Option_Types (Ctx : in out Context; Seq_Ctx : in out RFLX.Universal.Option_Types.Context)
   with
     Pre =>
   ...
   procedure Update_Options (Ctx : in out Context; Seq_Ctx : in out RFLX.Universal.Options.Context)
   with
     Pre =>
   ...
   procedure Update_Values (Ctx : in out Context; Seq_Ctx : in out RFLX.Universal.Values.Context)
   with
     Pre =>
...
private
   ...
   function Field_First_Option_Types (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 24)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
   ...
   function Field_First_Value (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 24)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_Value);

   function Field_First_Values (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 24)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     (case Fld is
          ...
          when F_Option_Types =>
             Field_First_Option_Types (Cursors, First, Verified_Last, Written_Last),
          when F_Options =>
