...
is
   ...
   begin
      ...
      if
         (Universal.Message.Well_Formed_Message (Ctx.P.M_R_Ctx) = True
          and then Universal.Message.Get_Message_Type (Ctx.P.M_R_Ctx) = Universal.MT_Data)
         and then Universal.Message.Get_Length (Ctx.P.M_R_Ctx) = 2
      then
   ...
   begin
      ...
      -- tests/feature/session_message_creation/test.rflx:25:10
      ...
      if Universal.Message.Available_Space (Ctx.P.M_S_Ctx, Universal.Message.F_Message_Type) < (Universal.Message.Size (Ctx.P.M_R_Ctx) / 8) * 8 + 24 then
         Ctx.P.Next_State := S_Final;
         pragma Assert (Process_Invariant);
         goto Finalize_Process;
      end if;
      ...
      Universal.Message.Set_Length (Ctx.P.M_S_Ctx, Universal.Length (Universal.Message.Size (Ctx.P.M_R_Ctx) / 8));
      if Universal.Message.Valid_Length (Ctx.P.M_S_Ctx, Universal.Message.F_Data, RFLX_Types.To_Length (Universal.Message.Size (Ctx.P.M_R_Ctx))) then
         declare
   ...
   begin
      ...
      -- tests/feature/session_message_creation/test.rflx:37:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
