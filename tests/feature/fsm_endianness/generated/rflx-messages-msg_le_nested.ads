...
package RFLX.Messages.Msg_LE_Nested
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   function Get_X_A (Ctx : Context) return RFLX.Messages.Integer
   with
     Pre =>
       RFLX.Messages.Msg_LE_Nested.Valid (Ctx, RFLX.Messages.Msg_LE_Nested.F_X_A);

   function Get_X_B (Ctx : Context) return RFLX.Messages.Enum_T
   with
     Pre =>
       RFLX.Messages.Msg_LE_Nested.Valid (Ctx, RFLX.Messages.Msg_LE_Nested.F_X_B);

   function Get_Y (Ctx : Context) return RFLX.Messages.Enum_T
   with
     Pre =>
   ...
   procedure Set_X_A (Ctx : in out Context; Val : RFLX.Messages.Integer)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_X_B (Ctx : in out Context; Val : RFLX.Messages.Enum_T)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Y (Ctx : in out Context; Val : RFLX.Messages.Enum_T)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   function Field_Size_X_A (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);

   function Field_Size_X_B (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);

   function Field_Size_Y (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);
...
private
   ...
   function Field_First_X_A (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_X_A);

   function Field_First_X_B (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 32)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_X_B);

   function Field_First_Y (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 64)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
