...
is
   ...
   function Get_A (Ctx : Context) return RFLX.Messages.Integer
   with
     Pre =>
       RFLX.Messages.Msg.Valid (Ctx, RFLX.Messages.Msg.F_A);

   function Get_B (Ctx : Context) return RFLX.Messages.Enum_T
   with
     Pre =>
   ...
   procedure Set_A (Ctx : in out Context; Val : RFLX.Messages.Integer)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_B (Ctx : in out Context; Val : RFLX.Messages.Enum_T)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   function Field_Size_A (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);

   function Field_Size_B (Struct : Structure) return RFLX_Types.Bit_Length
   with
     Pre =>
       Valid_Structure (Struct);
...
private
   ...
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_B);
