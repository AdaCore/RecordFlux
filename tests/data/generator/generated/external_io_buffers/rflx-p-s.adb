...
package body RFLX.P.S with
  SPARK_Mode
is

   procedure A (Ctx : in out Context'Class) with
     Pre =>
       Initialized (Ctx),
     Post =>
       Initialized (Ctx)
   ...
   procedure B (Ctx : in out Context'Class) with
     Pre =>
       Initialized (Ctx),
     Post =>
       Initialized (Ctx)
   ...
   procedure Initialize (Ctx : in out Context'Class; M_Buffer : in out RFLX_Types.Bytes_Ptr) is
   begin
   ...
   procedure Finalize (Ctx : in out Context'Class; M_Buffer : in out RFLX_Types.Bytes_Ptr) is
   begin
   ...
   procedure Add_Buffer (Ctx : in out Context'Class; Ext_Buf : External_Buffer; Buffer : in out RFLX_Types.Bytes_Ptr; Written_Last : RFLX_Types.Bit_Length) is
   begin
      case Ext_Buf is
         when B_M =>
   ...
   procedure Remove_Buffer (Ctx : in out Context'Class; Ext_Buf : External_Buffer; Buffer : out RFLX_Types.Bytes_Ptr) is
   begin
      case Ext_Buf is
         when B_M =>
            pragma Warnings (Off, """Ctx.P.M_Ctx"" is set by ""Take_Buffer"" but not used after the call");
