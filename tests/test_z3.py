...
class TestZ3(unittest.TestCase):  # pylint: disable=too-many-public-methods
    ...
    def test_and(self) -> None:
        ...
        self.assertEqual(
            And(TRUE, TRUE).z3expr(),
            z3.And(z3.BoolVal(True), z3.BoolVal(True)))
    ...
    def test_or(self) -> None:
        ...
        self.assertEqual(
            Or(TRUE, TRUE).z3expr(),
            z3.Or(z3.BoolVal(True), z3.BoolVal(True)))
    ...
    def test_pow(self) -> None:
        self.assertEqual(
            ...
            z3.IntVal(6) ** z3.IntVal(2))

    def test_mod(self) -> None:
        self.assertEqual(
            Mod(Number(1000), Number(5)).z3expr(),
            z3.IntVal(1000) % z3.IntVal(5))
    ...
    def test_less_equal(self) -> None:
        self.assertEqual(
            LessEqual(Number(1), Number(100)).z3expr(),
            z3.IntVal(1) <= z3.IntVal(100))

    def test_equal(self) -> None:
        self.assertEqual(
            Equal(Number(100), Number(100)).z3expr(),
            z3.IntVal(100) == z3.IntVal(100))
    ...
    def test_if(self) -> None:
        self.assertEqual(
            If([(Greater(Variable('a'), Number(5)), Number(1)),
                (Greater(Variable('b'), Number(100)), Number(10))],
               Number(100)).z3expr(),
            z3.If(z3.Int('a') > z3.IntVal(5),
                  z3.IntVal(1),
                  z3.If(z3.Int('b') > z3.IntVal(100),
                        z3.IntVal(10),
                        z3.IntVal(100))))
    ...
    def test_case(self) -> None:
        self.assertEqual(
            Case(Variable('x'),
                 [(Number(5), Number(1)),
                  (Number(10), Number(2))]).z3expr(),
            z3.If(z3.Int('x') == z3.IntVal(5),
                  z3.IntVal(1),
                  z3.If(z3.Int('x') == z3.IntVal(10),
                        z3.IntVal(2),
                        z3.BoolVal(False))))
