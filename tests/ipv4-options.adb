package body IPv4.Options is
   ...
   procedure First (Buffer : Types.Bytes; Offset : out Offset_Type; First : out Natural; Last : out Natural) is
   begin
   ...
   procedure Next (Buffer : Types.Bytes; Offset : in out Offset_Type; First : out Natural; Last : out Natural) is
   begin
