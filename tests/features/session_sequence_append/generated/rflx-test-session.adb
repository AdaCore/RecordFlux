...
is
   ...
   begin
      ...
      -- tests/features/session_sequence_append/test.rflx:13:10
   ...
   begin
      ...
      -- tests/features/session_sequence_append/test.rflx:22:10
      if
      ...
      -- tests/features/session_sequence_append/test.rflx:26:10
   ...
   begin
      ...
      -- tests/features/session_sequence_append/test.rflx:37:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
