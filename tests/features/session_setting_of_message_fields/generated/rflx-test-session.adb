...
is
   ...
   begin
      ...
      -- tests/features/session_setting_of_message_fields/test.rflx:12:10
   ...
   begin
      ...
      -- tests/features/session_setting_of_message_fields/test.rflx:25:10
      ...
      -- tests/features/session_setting_of_message_fields/test.rflx:31:10
   ...
   begin
      ...
      -- tests/features/session_setting_of_message_fields/test.rflx:42:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
