...
is
   ...
   begin
      ...
      -- tests/features/session_case_expression_aggregate/test.rflx:12:10
   ...
   begin
      ...
      -- tests/features/session_case_expression_aggregate/test.rflx:22:10
      ...
      -- tests/features/session_case_expression_aggregate/test.rflx:24:10
   ...
   begin
      ...
      -- tests/features/session_case_expression_aggregate/test.rflx:43:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
