...
is
   ...
   begin
      ...
      -- tests/features/session_endianness/test.rflx:16:10
   ...
   begin
      ...
      -- tests/features/session_endianness/test.rflx:25:10
   ...
   begin
      ...
      -- tests/features/session_endianness/test.rflx:34:10
   ...
   begin
      ...
      -- tests/features/session_endianness/test.rflx:41:10
   ...
   begin
      ...
      -- tests/features/session_endianness/test.rflx:50:10
   ...
   begin
      ...
      -- tests/features/session_endianness/test.rflx:59:10
