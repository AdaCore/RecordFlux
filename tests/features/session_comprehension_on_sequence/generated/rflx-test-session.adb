...
is
   ...
   begin
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:15:10
      if
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:17:10
      if
         not Universal.Options.Has_Element (Ctx.P.Options_Ctx)
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:19:10
      if
         not Universal.Options.Has_Element (Ctx.P.Options_Ctx)
   ...
   begin
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:31:10
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:33:10
      if Universal.Options.Valid (Ctx.P.Options_Ctx) then
         declare
            RFLX_Copy_Options_Ctx : Universal.Options.Context;
            RFLX_Copy_Options_Buffer : RFLX_Types.Bytes_Ptr;
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:35:10
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:39:10
      if Universal.Options.Valid (Ctx.P.Options_Ctx) then
         declare
            RFLX_Copy_Options_Ctx : Universal.Options.Context;
            RFLX_Copy_Options_Buffer : RFLX_Types.Bytes_Ptr;
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:41:10
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:45:10
      Universal.Options.Reset (Message_Options_Ctx);
   ...
   begin
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:55:10
   ...
   begin
      ...
      -- tests/features/session_comprehension_on_sequence/test.rflx:63:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Send_2_Invariant);
   end Send_2;
