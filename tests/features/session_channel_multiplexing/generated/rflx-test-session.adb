...
is
   ...
   begin
      ...
      -- tests/features/session_channel_multiplexing/test.rflx:15:10
      Universal.Message.Verify_Message (Ctx.P.Message_1_Ctx);
      -- tests/features/session_channel_multiplexing/test.rflx:16:10
   ...
   begin
      ...
      -- tests/features/session_channel_multiplexing/test.rflx:27:10
   ...
   begin
      ...
      -- tests/features/session_channel_multiplexing/test.rflx:34:10
      Ctx.P.Next_State := S_Start;
      pragma Assert (Reply_2_Invariant);
   end Reply_2;
