...
is
   ...
   begin
      ...
      -- tests/features/session_append_unconstrained/test.rflx:14:10
      if
      ...
      -- tests/features/session_append_unconstrained/test.rflx:16:10
      if
         not Universal.Options.Has_Element (Options_Ctx)
      ...
      -- tests/features/session_append_unconstrained/test.rflx:18:10
      if
         not Universal.Options.Has_Element (Options_Ctx)
      ...
      -- tests/features/session_append_unconstrained/test.rflx:20:10
   ...
   begin
      ...
      -- tests/features/session_append_unconstrained/test.rflx:29:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
