...
is
   ...
   begin
      ...
      -- tests/features/session_message_optimization/test.rflx:24:10
   ...
   begin
      ...
      -- tests/features/session_message_optimization/test.rflx:38:10
      ...
      -- tests/features/session_message_optimization/test.rflx:40:10
      Local_Length := Option_Data.Length;
      -- tests/features/session_message_optimization/test.rflx:42:10
      Universal.Option.Reset (Ctx.P.Option_Ctx);
      -- tests/features/session_message_optimization/test.rflx:44:10
   ...
   begin
      ...
      -- tests/features/session_message_optimization/test.rflx:59:10
   ...
   begin
      ...
      -- tests/features/session_message_optimization/test.rflx:68:10
      ...
      -- tests/features/session_message_optimization/test.rflx:70:10
