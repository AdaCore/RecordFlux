...
is
   ...
   begin
      ...
      -- tests/features/messages_with_single_opaque_field/test.rflx:16:10
   ...
   begin
      ...
      -- tests/features/messages_with_single_opaque_field/test.rflx:24:10
   ...
   begin
      ...
      -- tests/features/messages_with_single_opaque_field/test.rflx:33:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
