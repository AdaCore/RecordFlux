...
is
   ...
   begin
      ...
      -- tests/features/session_sequence_append_head/test.rflx:17:10
      if
      ...
      -- tests/features/session_sequence_append_head/test.rflx:18:10
      if
      ...
      -- tests/features/session_sequence_append_head/test.rflx:19:10
      ...
      -- tests/features/session_sequence_append_head/test.rflx:20:10
      ...
      -- tests/features/session_sequence_append_head/test.rflx:21:10
      if
   ...
   begin
      ...
      -- tests/features/session_sequence_append_head/test.rflx:33:10
   ...
   begin
      ...
      -- tests/features/session_sequence_append_head/test.rflx:45:10
      if
      ...
      -- tests/features/session_sequence_append_head/test.rflx:47:10
      if
         not TLV.Messages.Has_Element (Ctx.P.Messages_Ctx)
         or TLV.Messages.Available_Space (Ctx.P.Messages_Ctx) < 32
      then
      ...
      -- tests/features/session_sequence_append_head/test.rflx:48:10
      if
      ...
      -- tests/features/session_sequence_append_head/test.rflx:49:10
      if
         not TLV.Tags.Has_Element (Local_Tags_Ctx)
         or TLV.Tags.Available_Space (Local_Tags_Ctx) < TLV.Tag'Size
      then
      ...
      -- tests/features/session_sequence_append_head/test.rflx:50:10
      ...
      -- tests/features/session_sequence_append_head/test.rflx:51:10
      if TLV.Message.Valid (Ctx.P.Message_Ctx, TLV.Message.F_Tag) then
         Message_Tag := TLV.Message.Get_Tag (Ctx.P.Message_Ctx);
      else
         Ctx.P.Next_State := S_Final;
      ...
      -- tests/features/session_sequence_append_head/test.rflx:52:10
      if
   ...
   begin
      ...
      -- tests/features/session_sequence_append_head/test.rflx:64:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_2_Invariant);
   end Reply_2;
