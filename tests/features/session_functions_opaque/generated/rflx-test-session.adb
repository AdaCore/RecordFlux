...
is
   ...
   begin
      ...
      -- tests/features/session_functions_opaque/test.rflx:23:10
      ...
      -- tests/features/session_functions_opaque/test.rflx:25:10
      declare
   ...
   begin
      ...
      -- tests/features/session_functions_opaque/test.rflx:39:10
      if
      ...
      -- tests/features/session_functions_opaque/test.rflx:41:10
      declare
   ...
   begin
      ...
      -- tests/features/session_functions_opaque/test.rflx:55:10
      if
      ...
      -- tests/features/session_functions_opaque/test.rflx:57:10
      if
         not Universal.Values.Has_Element (Scalar_Sequence_Ctx)
         or Universal.Values.Available_Space (Scalar_Sequence_Ctx) < Universal.Value'Size
      then
      ...
      -- tests/features/session_functions_opaque/test.rflx:59:10
      declare
