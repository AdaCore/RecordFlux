...
is
   ...
   begin
      ...
      -- tests/features/session_comprehension_on_message_field/test.rflx:12:10
   ...
   begin
      ...
      -- tests/features/session_comprehension_on_message_field/test.rflx:24:10
      ...
      -- tests/features/session_comprehension_on_message_field/test.rflx:26:10
      Universal.Option_Types.Reset (Option_Types_Ctx);
      if Universal.Message.Well_Formed_Message (Ctx.P.Message_Ctx) then
         declare
            RFLX_Message_Options_Ctx : Universal.Options.Context;
      ...
      -- tests/features/session_comprehension_on_message_field/test.rflx:28:10
   ...
   begin
      ...
      -- tests/features/session_comprehension_on_message_field/test.rflx:39:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
