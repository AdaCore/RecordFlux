...
is
   ...
   begin
      ...
      -- tests/features/parameterized_messages/test.rflx:27:10
   ...
   begin
      ...
      -- tests/features/parameterized_messages/test.rflx:35:10
   ...
   begin
      ...
      -- tests/features/parameterized_messages/test.rflx:48:10
      ...
      if
         not (Test.Message.Size (Ctx.P.M_R_Ctx) <= 32768
          ...
          and then Test.Message.Well_Formed (Ctx.P.M_R_Ctx, Test.Message.F_Data))
      then
         Ctx.P.Next_State := S_Error;
         pragma Assert (Process_Invariant);
      ...
      if Test.Message.Valid_Next (Ctx.P.M_R_Ctx, Test.Message.F_Data) then
         if Test.Message.Valid_Length (Ctx.P.M_S_Ctx, Test.Message.F_Data, RFLX_Types.To_Length (Test.Message.Field_Size (Ctx.P.M_R_Ctx, Test.Message.F_Data))) then
            if Test.Message.Well_Formed (Ctx.P.M_R_Ctx, Test.Message.F_Data) then
               declare
      ...
      -- tests/features/parameterized_messages/test.rflx:49:10
      Length := Ctx.P.M_S_Ctx.Length;
      -- tests/features/parameterized_messages/test.rflx:50:10
      Test.Message.Reset (M_T_Ctx, Length => Ctx.P.M_S_Ctx.Length, Extended => True);
      -- tests/features/parameterized_messages/test.rflx:51:10
      ...
      -- tests/features/parameterized_messages/test.rflx:53:10
   ...
   begin
      ...
      -- tests/features/parameterized_messages/test.rflx:65:10
   ...
   begin
      ...
      -- tests/features/parameterized_messages/test.rflx:73:10
