...
is
   ...
   begin
      ...
      -- tests/features/session_comprehension_head/test.rflx:15:10
      if
      ...
      -- tests/features/session_comprehension_head/test.rflx:17:10
      if
         not Universal.Options.Has_Element (Ctx.P.Options_Ctx)
      ...
      -- tests/features/session_comprehension_head/test.rflx:19:10
      if
         not Universal.Options.Has_Element (Ctx.P.Options_Ctx)
   ...
   begin
      ...
      -- tests/features/session_comprehension_head/test.rflx:30:10
      ...
      -- tests/features/session_comprehension_head/test.rflx:32:10
      if Universal.Options.Valid (Ctx.P.Options_Ctx) then
         declare
            RFLX_Copy_Options_Ctx : Universal.Options.Context;
            RFLX_Copy_Options_Buffer : RFLX_Types.Bytes_Ptr;
   ...
   begin
      ...
      -- tests/features/session_comprehension_head/test.rflx:44:10
   ...
   begin
      ...
      -- tests/features/session_comprehension_head/test.rflx:52:10
   ...
   begin
      ...
      -- tests/features/session_comprehension_head/test.rflx:61:10
   ...
   begin
      ...
      -- tests/features/session_comprehension_head/test.rflx:72:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Send_2_Invariant);
   end Send_2;
