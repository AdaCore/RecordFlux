...
is
   ...
   begin
      ...
      -- tests/features/session_variable_initialization/test.rflx:14:10
   ...
   begin
      ...
      -- tests/features/session_variable_initialization/test.rflx:22:10
      ...
      -- tests/features/session_variable_initialization/test.rflx:23:10
      Ctx.P.Uninitialized_Global := Local;
      -- tests/features/session_variable_initialization/test.rflx:24:10
      Ctx.P.Global := Ctx.P.Uninitialized_Global + 20;
      -- tests/features/session_variable_initialization/test.rflx:26:10
   ...
   begin
      ...
      -- tests/features/session_variable_initialization/test.rflx:39:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
