...
is
   ...
   begin
      ...
      -- tests/features/session_case_expression_numeric/test.rflx:19:10
   ...
   begin
      ...
      -- tests/features/session_case_expression_numeric/test.rflx:29:10
      ...
      -- tests/features/session_case_expression_numeric/test.rflx:34:10
   ...
   begin
      ...
      -- tests/features/session_case_expression_numeric/test.rflx:43:10
      Ctx.P.Next_State := S_Final;
      pragma Assert (Reply_Invariant);
   end Reply;
