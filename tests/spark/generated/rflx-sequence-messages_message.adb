...
is
   ...
   begin
      ...
      Ctx.Cursors (Successor (Ctx, F_Messages)) := (State => S_Invalid, Predecessor => F_Messages, others => <>);
   ...
   begin
      ...
      if Valid_Sequence then
         ...
         Reset_Dependent_Fields (Ctx, F_Messages);
         Ctx.Cursors (F_Messages) := (State => S_Invalid, Predecessor => Ctx.Cursors (F_Messages).Predecessor, others => <>);
      end if;
   end Update_Messages;
