          ...
          when F_Sequence_Number =>
             (if
              ...
              then
                 ...
                 RFLX_Types.S63 (Ctx.Cursors (F_Tag).Value) = RFLX_Types.S63 (To_S63 (RFLX.ICMP.Information_Request))
