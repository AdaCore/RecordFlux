          ...
          when F_Sequence_Number =>
             (if
              ...
              then
                 ...
                 RFLX_Types.Base_Integer (Ctx.Cursors (F_Tag).Value) = RFLX_Types.Base_Integer (To_Base_Int (RFLX.ICMP.Information_Request))
