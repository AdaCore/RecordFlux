...
is
   ...
   function Get_Copied (Ctx : Context) return Boolean
   with
     Pre =>
       RFLX.IPv4.Option.Valid (Ctx, RFLX.IPv4.Option.F_Copied);

   function Get_Option_Class (Ctx : Context) return RFLX.IPv4.Option_Class
   with
     Pre =>
       RFLX.IPv4.Option.Valid (Ctx, RFLX.IPv4.Option.F_Option_Class);

   function Get_Option_Number (Ctx : Context) return RFLX.IPv4.Option_Number
   with
     Pre =>
       RFLX.IPv4.Option.Valid (Ctx, RFLX.IPv4.Option.F_Option_Number);

   function Get_Option_Length (Ctx : Context) return RFLX.IPv4.Option_Length
   with
     Pre =>
   ...
   function Get_Option_Data (Ctx : Context) return RFLX_Types.Bytes
   with
     Ghost,
     Pre =>
       RFLX.IPv4.Option.Has_Buffer (Ctx)
   ...
   procedure Generic_Get_Option_Data (Ctx : Context)
   with
     Pre =>
       RFLX.IPv4.Option.Has_Buffer (Ctx)
   ...
   procedure Set_Copied (Ctx : in out Context; Val : Boolean)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Option_Class (Ctx : in out Context; Val : RFLX.IPv4.Option_Class)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Option_Number (Ctx : in out Context; Val : RFLX.IPv4.Option_Number)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Option_Length (Ctx : in out Context; Val : RFLX.IPv4.Option_Length)
   with
     Inline_Always,
     Pre =>
       not Ctx'Constrained
   ...
   procedure Set_Option_Data_Empty (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.IPv4.Option.Has_Buffer (Ctx)
   ...
   procedure Initialize_Option_Data (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.IPv4.Option.Has_Buffer (Ctx)
   ...
   procedure Set_Option_Data (Ctx : in out Context; Data : RFLX_Types.Bytes)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.IPv4.Option.Has_Buffer (Ctx)
   ...
   procedure Generic_Set_Option_Data (Ctx : in out Context; Length : RFLX_Types.Length)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.IPv4.Option.Has_Buffer (Ctx)
...
private
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     (case Fld is
          ...
          when F_Option_Class =>
             Field_First_Option_Class (Cursors, First, Verified_Last, Written_Last),
          when F_Option_Number =>
             Field_First_Option_Number (Cursors, First, Verified_Last, Written_Last),
          when F_Option_Length =>
