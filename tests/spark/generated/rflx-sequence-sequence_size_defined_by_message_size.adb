...
is
   ...
   with
     Pre =>
       ...
       and then not RFLX.Sequence.Sequence_Size_Defined_By_Message_Size.Composite_Field (Fld) is
   ...
   with
     ...
     Post =>
       ...
       and then Field_First (Ctx, F_Vector) = Field_First (Ctx, F_Vector)'Old is
