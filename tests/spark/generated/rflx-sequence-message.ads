...
is
   ...
   function Get_Length (Ctx : Context) return RFLX.Sequence.Length
   with
     Pre =>
   ...
   procedure Set_Integer_Vector_Empty (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Message.Has_Buffer (Ctx)
   ...
   procedure Set_Integer_Vector (Ctx : in out Context; Seq_Ctx : RFLX.Sequence.Integer_Vector.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Message.Has_Buffer (Ctx)
   ...
   procedure Set_Enumeration_Vector (Ctx : in out Context; Seq_Ctx : RFLX.Sequence.Enumeration_Vector.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Message.Has_Buffer (Ctx)
   ...
   procedure Set_AV_Enumeration_Vector (Ctx : in out Context; Seq_Ctx : RFLX.Sequence.AV_Enumeration_Vector.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_Integer_Vector (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_Enumeration_Vector (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_AV_Enumeration_Vector (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Message.Has_Buffer (Ctx)
   ...
   procedure Switch_To_Integer_Vector (Ctx : in out Context; Seq_Ctx : out RFLX.Sequence.Integer_Vector.Context)
   with
     Pre =>
       not Ctx'Constrained
   ...
   procedure Switch_To_Enumeration_Vector (Ctx : in out Context; Seq_Ctx : out RFLX.Sequence.Enumeration_Vector.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then not Seq_Ctx'Constrained
   ...
   procedure Switch_To_AV_Enumeration_Vector (Ctx : in out Context; Seq_Ctx : out RFLX.Sequence.AV_Enumeration_Vector.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then not Seq_Ctx'Constrained
   ...
   function Complete_Integer_Vector (Ctx : Context; Seq_Ctx : RFLX.Sequence.Integer_Vector.Context) return Boolean
   with
     Pre =>
       RFLX.Sequence.Message.Valid_Next (Ctx, RFLX.Sequence.Message.F_Integer_Vector);

   function Complete_Enumeration_Vector (Ctx : Context; Seq_Ctx : RFLX.Sequence.Enumeration_Vector.Context) return Boolean
   with
     Pre =>
       RFLX.Sequence.Message.Valid_Next (Ctx, RFLX.Sequence.Message.F_Enumeration_Vector);

   function Complete_AV_Enumeration_Vector (Ctx : Context; Seq_Ctx : RFLX.Sequence.AV_Enumeration_Vector.Context) return Boolean
   with
     Pre =>
       RFLX.Sequence.Message.Valid_Next (Ctx, RFLX.Sequence.Message.F_AV_Enumeration_Vector);

   procedure Update_Integer_Vector (Ctx : in out Context; Seq_Ctx : in out RFLX.Sequence.Integer_Vector.Context)
   with
     Pre =>
   ...
   procedure Update_Enumeration_Vector (Ctx : in out Context; Seq_Ctx : in out RFLX.Sequence.Enumeration_Vector.Context)
   with
     Pre =>
   ...
   procedure Update_AV_Enumeration_Vector (Ctx : in out Context; Seq_Ctx : in out RFLX.Sequence.AV_Enumeration_Vector.Context)
   with
     Pre =>
...
private
   ...
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_AV_Enumeration_Vector);
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     (case Fld is
          ...
          when F_Integer_Vector =>
             Field_First_Integer_Vector (Cursors, First, Verified_Last, Written_Last),
          when F_Enumeration_Vector =>
