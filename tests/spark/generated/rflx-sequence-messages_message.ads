...
package RFLX.Sequence.Messages_Message
with
  SPARK_Mode,
  Always_Terminates
is
   ...
   procedure Set_Messages_Empty (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Messages_Message.Has_Buffer (Ctx)
   ...
   procedure Set_Messages (Ctx : in out Context; Seq_Ctx : RFLX.Sequence.Inner_Messages.Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Messages_Message.Has_Buffer (Ctx)
   ...
   procedure Initialize_Messages (Ctx : in out Context)
   with
     Pre =>
       not Ctx'Constrained
       and then RFLX.Sequence.Messages_Message.Has_Buffer (Ctx)
   ...
   procedure Switch_To_Messages (Ctx : in out Context; Seq_Ctx : out RFLX.Sequence.Inner_Messages.Context)
   with
     Pre =>
       not Ctx'Constrained
   ...
   function Complete_Messages (Ctx : Context; Seq_Ctx : RFLX.Sequence.Inner_Messages.Context) return Boolean
   with
     Pre =>
       RFLX.Sequence.Messages_Message.Valid_Next (Ctx, RFLX.Sequence.Messages_Message.F_Messages);

   procedure Update_Messages (Ctx : in out Context; Seq_Ctx : in out RFLX.Sequence.Inner_Messages.Context)
   with
     Pre =>
...
private
   ...
   function Field_First_Messages (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length) return RFLX_Types.Bit_Index'Base is
     (First + 8)
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
       and then Valid_Next_Internal (Cursors, First, Verified_Last, Written_Last, F_Messages);
   ...
   function Field_First_Internal (Cursors : Field_Cursors; First : RFLX_Types.Bit_Index; Verified_Last : RFLX_Types.Bit_Length; Written_Last : RFLX_Types.Bit_Length; Fld : Field) return RFLX_Types.Bit_Index'Base is
     (case Fld is
          ...
          when F_Messages =>
             Field_First_Messages (Cursors, First, Verified_Last, Written_Last))
   with
     Pre =>
       Cursors_Invariant (Cursors, First, Verified_Last)
       and then Valid_Predecessors_Invariant (Cursors, First, Verified_Last, Written_Last)
