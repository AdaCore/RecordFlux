...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ada.Initializes(ID("X")), "Initializes =>\n  X"),
        (ada.Initializes(ID("X"), ID("Y")), "Initializes =>\n  (X, Y)"),
        (ada.Global(), "Global =>\n  null"),
        (ada.Global(inputs=[ID("X.Y")]), "Global =>\n  (Input => X.Y)"),
        (ada.Global(inputs=[ID("X"), ID("Y")]), "Global =>\n  (Input => (X, Y))"),
        (
            ada.Global(inputs=[ID("X")], outputs=[ID("Y"), ID("Z")]),
            "Global =>\n  (Input => X, Output => (Y, Z))",
        ),
        (
            ada.Global(inputs=[ID("X")], outputs=[ID("Y")], in_outs=[ID("Z")]),
            "Global =>\n  (Input => X, Output => Y, In_Out => Z)",
        ),
        (ada.Import(), "Import"),
