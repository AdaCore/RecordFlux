...
is
   ...
   function Get_Version_0 (Buffer : Bytes) return Version_Type is
   ...
   function Get_Version (Buffer : Bytes) return Version_Type is
   ...
   function Get_IHL_00 (Buffer : Bytes) return IHL_Type is
   ...
   function Get_IHL (Buffer : Bytes) return IHL_Type is
   ...
   function Get_DSCP_000 (Buffer : Bytes) return DCSP_Type is
   ...
   function Get_DSCP (Buffer : Bytes) return DCSP_Type is
   ...
   function Get_ECN_0000 (Buffer : Bytes) return ECN_Type is
   ...
   function Get_ECN (Buffer : Bytes) return ECN_Type is
   ...
   function Get_Total_Length_00000 (Buffer : Bytes) return Total_Length_Type is
   ...
   function Get_Total_Length (Buffer : Bytes) return Total_Length_Type is
   ...
   function Get_Identification_000000 (Buffer : Bytes) return Identification_Type is
   ...
   function Get_Identification (Buffer : Bytes) return Identification_Type is
   ...
   function Get_Flag_R_0000000 (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Flag_R (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Flag_DF_00000000 (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Flag_DF (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Flag_MF_000000000 (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Flag_MF (Buffer : Bytes) return Flag_Type is
   ...
   function Get_Fragment_Offset_0000000000 (Buffer : Bytes) return Fragment_Offset_Type is
   ...
   function Get_Fragment_Offset (Buffer : Bytes) return Fragment_Offset_Type is
   ...
   function Get_TTL_00000000000 (Buffer : Bytes) return TTL_Type is
   ...
   function Get_TTL (Buffer : Bytes) return TTL_Type is
   ...
   function Get_Protocol_000000000000 (Buffer : Bytes) return Protocol_Type is
   ...
   function Get_Protocol (Buffer : Bytes) return Protocol_Type is
   ...
   function Get_Header_Checksum_0000000000000 (Buffer : Bytes) return Header_Checksum_Type is
   ...
   function Get_Header_Checksum (Buffer : Bytes) return Header_Checksum_Type is
   ...
   function Get_Source_00000000000000 (Buffer : Bytes) return Address_Type is
   ...
   function Get_Source (Buffer : Bytes) return Address_Type is
   ...
   function Get_Destination_000000000000000 (Buffer : Bytes) return Address_Type is
   ...
   function Get_Destination (Buffer : Bytes) return Address_Type is
   ...
   function Get_Options_0000000000000001_First (Buffer : Bytes) return Natural is
      ((Buffer'First + 20))
     with
       Pre => (Is_Contained (Buffer) and then Valid_Options_0000000000000001 (Buffer));

   function Get_Options_0000000000000001_Last (Buffer : Bytes) return Natural is
   ...
   function Get_Options_First (Buffer : Bytes) return Natural is
   ...
   function Get_Options_Last (Buffer : Bytes) return Natural is
      ((if Valid_Options_0000000000000001 (Buffer) then Get_Options_0000000000000001_Last (Buffer) else Unreachable_Natural))
     with
       Pre => (Is_Contained (Buffer) and then Valid_Options (Buffer));

   procedure Get_Options (Buffer : Bytes; First : out Natural; Last : out Natural)
     with
       Pre => (Is_Contained (Buffer) and then Valid_Options (Buffer)),
   ...
   function Get_Payload_0000000000000000_First (Buffer : Bytes) return Natural is
      ((Buffer'First + 20))
     with
       Pre => (Is_Contained (Buffer) and then Valid_Payload_0000000000000000 (Buffer));

   function Get_Payload_0000000000000000_Last (Buffer : Bytes) return Natural is
   ...
   function Get_Payload_00000000000000010_First (Buffer : Bytes) return Natural is
      ((Buffer'First + (Natural (Get_IHL_00 (Buffer)) * 4)))
     with
       Pre => (Is_Contained (Buffer) and then Valid_Payload_00000000000000010 (Buffer));

   function Get_Payload_00000000000000010_Last (Buffer : Bytes) return Natural is
      ((Buffer'First + Natural (Get_Total_Length_00000 (Buffer)) + (-1)))
     with
       Pre => (Is_Contained (Buffer) and then Valid_Payload_00000000000000010 (Buffer));
