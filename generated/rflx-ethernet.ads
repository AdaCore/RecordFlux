...
is
   ...
   function Convert is new RFLX.Types.Convert_To_Int (Type_Length_Base);
   ...
   function Convert is new RFLX.Types.Convert_To_Int (TPID_Base);
   ...
   function Convert is new RFLX.Types.Convert_To_Mod (TCI);
